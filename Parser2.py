...
def parser(subdir="raw.es", encode="utf8"):
	...
	init = ".*<doc.*>.*"
	fin = ".*</doc>.*"
	titleregex = r'title=".*?"' #Para obtener el título de cada documento
	espacios = "\s+"
	lineWrite = ""
	...
	for root, dirs, files in walk(subdir): #Obtiene la lista de los archivos
		...
		break #Sólo iterar sobre un nivel, para no iterar sobre los archivos de las carpetas Parseados, Titulos e Indexados
